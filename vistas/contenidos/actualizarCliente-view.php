                ...
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" pattern="[0-9-]{1,27}" class="form-control" name="cliente_rtn_up" id="cliente_rtn" maxlength="27">
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            <label for="correo" class="bmd-label-floating">Correo Electronico</label>
                            <input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,40}" class="form-control" name="cliente_correo_up" id="cliente_correo" maxlength="40">
                        </div>
                    </div>
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            <label for="cliente_direccion" class="bmd-label-floating">Direccion</label>
                            <input type="text" pattern="[0-9()+]{8,20}" class="form-control" name="cliente_direccion_up" id="cliente_direccion" maxlength="20">
                        </div>
                    </div>
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            <label for="cliente_telefono" class="bmd-label-floating">Telefono</label>
                            <input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{1,150}" class="form-control" name="cliente_telefono_up" id="client_telefono" maxlength="150">
                        </div>
                    </div>
                </div>
            </div>
